Ext.define('Mobile.view.SpatialResults', {
    ...
    config: {
        ...
        items: [
            {
                xtype: 'list',
                id: 'SpatialResultsList',
                ui: 'round',
                flex: 1,
                style: 'font: 8px;',

                store: Ext.create('Mobile.store.SpatialResultsStore'),

                emptyText: '<p class="no-searches">No test results found matching that search</p>',
                autoLoad: true,
